...
def main():
  ...
  print('Accuracy of Logistics Regression: {}'.format(acc_train_lr))

  y_val_pred_lr = lr.predict(X_val)
  acc_val_lr = accuracy_score(y_val_pred_lr, y_val)
  print('Accuracy of Logistics Regression: {}'.format(acc_val_lr))
  ...
  print('Accuracy of Random Forest Classifier: {}'.format(acc_train_rf))

  y_val_pred_rf = rfc.predict(X_val)
  acc_val_rf = accuracy_score(y_val_pred_rf, y_val)
  print('Accuracy of Random Forest Classifier: {}'.format(acc_val_rf))
